...
class ApiClient {
  ApiClient({
    this.basePath = 'https://pokeapi.co',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'ExamplePokemon':
          return ExamplePokemon.fromJson(value);
        case 'Machine':
          return Machine.fromJson(value);
        case 'PokemonAbilitiesInner':
          return PokemonAbilitiesInner.fromJson(value);
        case 'PokemonMovesInner':
